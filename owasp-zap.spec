...
ZAP_DOWNLOAD_URL=http://github.com/zaproxy/zaproxy/releases/download/v2.12.0/ZAP_2.12.0_Linux.tar.gz
ZAP_DOWNLOAD_DEST=/tmp/ZAP_2.12.0_Linux.tar.gz
ZAP_DOWNLOAD_CHECKSUM=9c4493c991cb9347063864d2436a3795cf3b69760625e7b3db401cd342d3fc55
